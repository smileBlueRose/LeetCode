...
**Time complexity:** O(n) — two passes to compute the max arrays, plus one pass to sum the water.

**Space complexity:** O(n) — two auxiliary arrays of the same length as the input.